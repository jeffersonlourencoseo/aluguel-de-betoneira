...
## Características Técnicas da Betoneira 120 Litros

- **Capacidade do tambor**: 120 litros
- **Capacidade de mistura**: 80 litros
- **Motor**: Elétrico 1/2 CV ou Gasolina 5,5 HP
- **Peso**: Aproximadamente 210 kg
- **Dimensões**: Compacta e fácil de transportar em caminhões de pequeno porte
- **Produção estimada**: Até 2 m³ de concreto por dia
- **Voltagem**: 220V monofásico (modelo elétrico)

O peso de apenas 210 kg torna a betoneira 120 litros um dos equipamentos mais fáceis de transportar. Ela cabe na maioria das carrocerias reforçadas de picapes e caminhões de pequeno porte, reduzindo o custo de frete e agilizando a entrega. Para obras na zona Norte do Rio, como Penha, Ramos, Olaria e Vicente de Carvalho, a entrega pode ser feita no mesmo dia.

## Para Qual Tipo de Obra a Betoneira 120L é Indicada?

A betoneira 120 litros brilha em projetos de pequeno porte onde a demanda de concreto é moderada e o espaço no canteiro é limitado. Veja os cenários mais comuns de uso:

- **Pequenas reformas em residências**: Contrapiso, pisos, reparos de laje e pequenas fundações
- **Construção de muros e calçadas**: Volume perfeito para muros de arrimo, calçadas residenciais e pisos de garagem
- **Projetos de concreto em pequena escala**: Pergolados, quiosques, churrasqueiras e áreas de lazer
- **Obras em locais com acesso restrito**: Sua compactura permite passar por portões estreitos e espaços apertados

## Vantagens da Locação de Betoneira 120 Litros
...
4. **Preço justo**: O **aluguel de betoneira 120 litros** tem o menor custo de locação da nossa frota. É a opção mais econômica para quem precisa de concreto sem investir em equipamento próprio.

## Comparação: Betoneira 120L vs. 150L
...
Para maximizar a produtividade e garantir a segurança da equipe, siga algumas orientações básicas. Sempre posicione a betoneira em solo plano e firme antes de ligar o motor. Não ultrapasse a capacidade máxima de mistura de 80 litros para evitar sobrecarga no motor de 1/2 CV. Após cada dia de uso, limpe o tambor com água para evitar o acúmulo de concreto seco.

Se a betoneira for a gasolina, mantenha o local ventilado e afastado de materiais inflamáveis. Nunca remova a tampa de proteção das engrenagens durante a operação. Nossa equipe entrega instruções completas de uso no momento da instalação.
